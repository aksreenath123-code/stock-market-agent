...
def fetch_moneycontrol_earnings():
    ...
    if not MONEYCONTROL_COOKIE:
        print("⚠️ MONEYCONTROL_COOKIE ലഭ്യമല്ല. ഈ ഭാഗം സ്കിപ്പ് ചെയ്യുന്നു.")
        return ""
    ...
    if ipo_data.strip() or earnings_data.strip():
        try:
            if ipo_data:
                ...
                ipo_result = "<p style='color: #b91c1c; font-weight: bold;'>⚠️ Post-IPO data could not be fetched today.</p>"
